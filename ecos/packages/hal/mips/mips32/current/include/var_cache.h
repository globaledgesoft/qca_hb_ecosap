...
#ifdef CYGPKG_HAL_MIPS_KSEG0_CACHE_CONFIG

#if (CYGPKG_HAL_MIPS_KSEG0_CACHE_CONFIG == 0)
#define HAL_DCACHE_UNCACHED_MODE        0
#define HAL_DCACHE_WRITETHRU_MODE       1
#define HAL_DCACHE_WRITEBACK_MODE       0
#elif (CYGPKG_HAL_MIPS_KSEG0_CACHE_CONFIG == 3)
#define HAL_DCACHE_UNCACHED_MODE        0
#define HAL_DCACHE_WRITETHRU_MODE       0
#define HAL_DCACHE_WRITEBACK_MODE       1
#else
#define HAL_DCACHE_UNCACHED_MODE        1
#define HAL_DCACHE_WRITETHRU_MODE       0
#define HAL_DCACHE_WRITEBACK_MODE       0
#endif

#else
#error "MIPS Cache mode 'CYGPKG_HAL_MIPS_KSEG0_CACHE_CONFIG' not set!"
#endif /* CYGPKG_HAL_MIPS_KSEG0_CACHE_CONFIG */
...
#define CHECK_CACHE_ALIGNED_ENABLED

#ifdef CHECK_CACHE_ALIGNED_ENABLED

#define CHECK_CACHE_ALIGNED(x) do { \
        if ((CYG_ADDRESS)(x) & (HAL_DCACHE_LINE_SIZE-1)) { \
            diag_printf("WARNING: %s:%d Address 0x%08x not cache aligned\n", \
                        __func__, __LINE__, (CYG_ADDRESS)(x)); \
        } \
    } while (0);
#else
#define CHECK_CACHE_ALIGNED(x)
#endif
