...
#define RST_WATCHDOG_TIMER_CONTROL_NOACTION                          0x00
#define RST_WATCHDOG_TIMER_CONTROL_GPINT                             0x01
#define RST_WATCHDOG_TIMER_CONTROL_NMI                               0x02
#define RST_WATCHDOG_TIMER_CONTROL_RESET                             0x03
...
#define GPIO_OE                                                      (ATH_GPIO_BASE + 0x0000)
#define	GPIO_IN                                                      (ATH_GPIO_BASE + 0x0004)
#define	GPIO_OUT                                                     (ATH_GPIO_BASE + 0x0008)
#define	GPIO_SET                                                     (ATH_GPIO_BASE + 0x000c)
#define	GPIO_CLEAR                                                   (ATH_GPIO_BASE + 0x0010)
#define	GPIO_INT                                                     (ATH_GPIO_BASE + 0x0014)
#define	GPIO_INT_TYPE                                                (ATH_GPIO_BASE + 0x0018)
#define	GPIO_INT_POLARITY                                            (ATH_GPIO_BASE + 0x001c)
#define	GPIO_INT_PENDING                                             (ATH_GPIO_BASE + 0x0020)
#define	GPIO_INT_MASK                                                (ATH_GPIO_BASE + 0x0024)
#define	GPIO_IN_ETH_SWITCH_LED                                       (ATH_GPIO_BASE + 0x0028)
#define	GPIO_OUT_FUNCTION0                                           (ATH_GPIO_BASE + 0x002c)
#define	GPIO_OUT_FUNCTION1                                           (ATH_GPIO_BASE + 0x0030)
#define	GPIO_OUT_FUNCTION2                                           (ATH_GPIO_BASE + 0x0034)
#define	GPIO_OUT_FUNCTION3                                           (ATH_GPIO_BASE + 0x0038)
#define	GPIO_OUT_FUNCTION4                                           (ATH_GPIO_BASE + 0x003c)
#define	GPIO_IN_ENABLE0                                              (ATH_GPIO_BASE + 0x0044)
#define	GPIO_FUNCTION                                                (ATH_GPIO_BASE + 0x006c)
