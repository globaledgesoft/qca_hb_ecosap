...
/* DHCP mask */
#define TAG_DHCP_MASK           ((unsigned char)  1)
/* DHCP router IP */
#define TAG_DHCP_ROUTER         ((unsigned char)  3)
/* DHCP Domain Name Server */
#define TAG_DHCP_DNS            ((unsigned char)  6)
/* DHCP Domain Name */
#define TAG_DHCP_DOMAINNAME     ((unsigned char)  15)
/* DHCP Padding bits */
#define TAG_DHCP_PADDING        ((unsigned char)  0)
...
extern char  *WAN_interface;//TODO
