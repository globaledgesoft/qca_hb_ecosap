...
const struct eth_drv_sc sc = {&sc##_funs, priv, name};
...
// Control 'key's
#define ETH_DRV_SET_MAC_ADDRESS 0x0099
//#define ETH_DRV_SET_MAC_ADDRESS SIOCSIFHWADDR
#define ETH_DRV_GET_MAC_ADDRESS SIOCGIFHWADDR

#ifdef CYGPKG_NET
#define ETH_DRV_GET_IF_STATS_UD 0x0101
#define ETH_DRV_GET_IF_STATS    0x0102
#define ETH_DRV_GMAC_QOS    	_IOWR('i', 129, struct ifreq)
#define ETH_DRV_GMAC		_IOWR('i', 130, struct ifreq)
#define ETH_DRV_PHY		_IOWR('i', 131, struct ifreq)
#define ETH_DRV_VLAN		_IOWR('i', 132, struct ifreq)
#define ETH_DRV_HW		_IOWR('i', 133, struct ifreq)
